...
export default class TherapistUserController extends AbstractController {
    ...
    private login = async (req: Request, res: Response) => {
        /*
            #swagger.tags = ['TherapistUser']
            #swagger.description = 'Endpoint para logar um usuario fono'
            #swagger.security = [{
                "basicApiKeyAuth": []
            }
        */
        ...
        // }
        // const user = await TherapistUser.findOne(authObj);
